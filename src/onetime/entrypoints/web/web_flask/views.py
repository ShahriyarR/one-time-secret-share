...
from onetime.entrypoints.web.web_flask.forms import SecretCreateForm
...
@inject
def index(
    secret_and_url_manager: SecretAndUrlManager = Provide[Container.secret_and_url_manager],
):
